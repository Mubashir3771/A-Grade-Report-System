...
$sql="SELECT * FROM `add_teacher` WHERE Email ='$email' AND Password ='$password'";
...
if ($result) {
  ...
  window.location.href = "taecherLogin.php";
  </script>
  ';
}
...
<!doctype html>
    ...
    <div class="col-md-6 m-auto ">
        ...
        <div class=" text-center font-weight-bold font-size-15 text-success  "> <h3>Teacher Dashboard</h3></div>
